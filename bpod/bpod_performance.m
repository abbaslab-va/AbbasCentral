%{
Lowell Bartlett - 12/09/2022 - Abbas Lab
This function returns a vector by trial type of the number of completed
trials of each trial type, as well as the number correctly completed for
the trial type of interest.
