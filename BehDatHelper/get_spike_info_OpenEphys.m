function spikeStruct = get_spike_info_OpenEphys(sessPath, regions, includeMua, includeWaveforms, numSamples)
...
try clusterInfo = tdfread(strcat(sessPath, '\cluster_info.tsv'));
    ...
    spikeStruct = get_spike_info_OpenEphys_noPhy(sessPath);
    return
end
